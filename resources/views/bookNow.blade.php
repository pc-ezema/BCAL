...
<head>
    ...
    <link href="{{URL::asset('fonts.googleapis.com/css2d0ac.css?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&amp;family=Poppins:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&amp;display=swap')}}" rel="stylesheet">

    <link rel="stylesheet" href="{{URL::asset('vendors/fontawesome-pro-5/css/all.css')}}">
    <link rel="stylesheet" href="{{URL::asset('vendors/bootstrap-select/css/bootstrap-select.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('vendors/slick/slick.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('vendors/magnific-popup/magnific-popup.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('vendors/jquery-ui/jquery-ui.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('vendors/chartjs/Chart.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('vendors/dropzone/css/dropzone.min.css')}}">
    ...
    <link rel="stylesheet" href="{{URL::asset('vendors/mapbox-gl/mapbox-gl.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('vendors/dataTables/jquery.dataTables.min.css')}}">
    ...
    <meta name="twitter:title" content="B-CAL">
    <meta name="twitter:description" content="B-CAL is a Property Development Company committed to providing elegant homes to individuals, institutions and corporate entities">
    <meta name="twitter:image" content="{{URL::asset('images/page/logo.png')}}">

    <meta property="og:url" content="{{route('index')}}">
    <meta property="og:title" content="B-CAL">
    <meta property="og:description" content="B-CAL is a Property Development Company committed to providing elegant homes to individuals, institutions and corporate entities">
    <meta property="og:type" content="website">
    <meta property="og:image" content="{{URL::asset('images/page/logo.png')}}">
...
<body>
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=1085156746533692&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
    ...
    <main id="content">
        <section
            style="background-image: url('images/page/inquiry.png'); background-position: left;"
    ...
    <script src="{{URL::asset('vendors/bootstrap-select/js/bootstrap-select.min.js')}}"></script>
    <script src="{{URL::asset('vendors/slick/slick.min.js')}}"></script>
    <script src="{{URL::asset('vendors/waypoints/jquery.waypoints.min.js')}}"></script>
    <script src="{{URL::asset('vendors/counter/countUp.js')}}"></script>
    <script src="{{URL::asset('vendors/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{URL::asset('vendors/chartjs/Chart.min.js')}}"></script>
    <script src="{{URL::asset('vendors/dropzone/js/dropzone.min.js')}}"></script>
    <script src="{{URL::asset('vendors/timepicker/bootstrap-timepicker.min.js')}}"></script>
    <script src="{{URL::asset('vendors/hc-sticky/hc-sticky.min.js')}}"></script>
    <script src="{{URL::asset('vendors/jparallax/TweenMax.min.js')}}"></script>
    <script src="{{URL::asset('vendors/mapbox-gl/mapbox-gl.js')}}"></script>
    <script src="{{URL::asset('vendors/dataTables/jquery.dataTables.min.js')}}"></script>
